...
# Hot corners (Read more: https://blog.jiayu.co/2018/12/quickly-configuring-hot-corners-on-macos/)
# Possible values:
#  0: no-op
#  2: Mission Control
...
# Disable dark mode in Google Chrome. This helps to recognise incognito better.
